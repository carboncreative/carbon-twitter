...
$my_consumer_key        = get_option('carbon_twitter_key');
$my_consumer_secret     = get_option('carbon_twitter_secret');
$my_access_token        = get_option('carbon_twitter_token');
$my_access_token_secret = get_option('carbon_twitter_token_secret');
$my_domain              = home_url();
